...
/* package infinityApp-0.1.0.0 */
#ifndef VERSION_infinityApp
#define VERSION_infinityApp "0.1.0.0"
#endif /* VERSION_infinityApp */
#ifndef MIN_VERSION_infinityApp
#define MIN_VERSION_infinityApp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_infinityApp */
...
#define CURRENT_COMPONENT_ID "infinityApp-0.1.0.0-inplace-infinityApp"
